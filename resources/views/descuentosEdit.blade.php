    ...
    <div class="">
        ...
        <div class="">
            ...
            <form class="form__reg" action="/editDescuentos/{{ $descuentos->id }}" method="POST">
                ...
                <div class="row">
                    <div class="col">
                        <input type="text" class="form-control" placeholder="Ingresar Descuento" name="descuento" value="{{ $descuentos->descripcion }}">
                        <br>
                        <input type="text" class="form-control" placeholder="Ingresar Valor" name="valor" value="{{ $descuentos->valor }}">
                        <br>
                        @if ($errors->isEmpty())
                        @else
