  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-6">
        ...
        <br>
        <h4>Total nomina</h4>
        <input type="text" class="form-control" placeholder="Total nomina" name="total_nomina">
        <br>
        <h4>Total descuentos</h4>
        <input type="text" class="form-control" placeholder="Total descuentos" name="total_descuentos">
        <br>
        <h4>Total extras</h4>
        <input type="text" class="form-control" placeholder="Total extras" name="total_extras">
        <br>
      </div>
