<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
  ...
  <ul class="c-sidebar-nav">
    ...
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
      ...
      <ul class="c-sidebar-nav-dropdown-items">
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="nominageneral"><span class="c-sidebar-nav-icon"></span> Fechas Nomina</a></li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="nominaindividual"><span class="c-sidebar-nav-icon"></span> Generar Nomina</a></li>
